    ...
    private static boolean intentarMover(int idFicha, Scanner sc) {
        ...
        if (estaFichaPuedeComer) {
            ...
            for (int deltaFila : dFilas) {
                // Dirección fija en pantalla: 1 -> Izquierda (-1 en columna), 2 -> Derecha (+1 en columna)
        ...
        // Mapeo unificado para pantalla:
        // Opción 1 (Izquierda) -> Mueve a la columna anterior (-1)
        // Opción 2 (Derecha)   -> Mueve a la columna siguiente (+1)
